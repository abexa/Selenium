...
public  class CrateTemplateHsns implements DataSetTemplate  {
	
	public static Connection conn = null;
	public static ResultSet rs;
	public static String etlresult = null;
    public static String somaResult = null;
    public static String stagingtabel =null;
	...
	public String EtlSuccess() throws SQLException {
		...
		String sql  = "select * from HSNS_STAGE";
